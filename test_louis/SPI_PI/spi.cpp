...
using namespace std;
  ...
  { // Calculate distance from left and right wheels
    ...
    voiture->addEncodeurWheelBackLeft(dist);
      cout << "Left " << (float)cpt_100m <<"/"<< (float)cpt_1m <<"/"<< (float)cpt_1cm<< " = "<<voiture->getEncodeurWheelBackLeft()<< endl;
    ...
    dist = (float)(cpt_100m)*100.0 + (float)(cpt_1m)*1.0 + (float)(cpt_1cm)*0.01;
    voiture->addEncodeurWheelBackRight(dist);
      cout << "Left " << (float)cpt_100m <<"/"<< (float)cpt_1m <<"/"<< (float)cpt_1cm<< " = "<<voiture->getEncodeurWheelBackRight()<< endl;
